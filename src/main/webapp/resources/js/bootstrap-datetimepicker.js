            ...
            return (
                '<div class="timepicker-picker">' +
                    '<table class="table-condensed">' +
						'<tr>' +
							'<td><button type="button" class="btn btn-time" data-action="incrementHours"><i class="fa fa-chevron-up" aria-hidden="true"></i></button></td>' +
							'<td class="separator"></td>' +
							'<td>' + (picker.options.useMinutes ? '<button type="button" class="btn btn-time" data-action="incrementMinutes"><i class="fa fa-chevron-up" aria-hidden="true"></i></button>' : '') + '</td>' +
                            (picker.options.useSeconds ?
                                '<td class="separator"></td><td><button type="button" class="btn btn-time" data-action="incrementSeconds"><i class="fa fa-chevron-up" aria-hidden="true"></i></button></td>' : '') +
