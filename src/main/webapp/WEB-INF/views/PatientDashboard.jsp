...
<html>
	...
	<div class="wrapper">
		<header class="main-header"> <!-- Logo --> <a href="index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		<span class="logo-mini"><b>A</b>LT</span> <!-- logo for regular state and mobile devices -->
		<span class="logo-lg">P-Care | Dashboard</span>
		</a> <!-- Header Navbar: style can be found in header.less --> <nav class="navbar navbar-static-top" role="navigation">
		...
		class="user-image" alt="User Image"> <span class="hidden-xs">Paul
		Pierce</span>
		</a></li>
		...
		<td>Radiology.</td>
		<td><button class="btn btn-block btn-success btn-xs">Online</button></td>
		...
		Available</span></td>
		<td>Cardiology.</td>
		<td><button class="btn btn-block btn-danger btn-xs">Offline</button></td>
		</tr>
		<tr>
		<td>657</td>
		<td>Bob Doe</td>
		<td>11-7-2014</td>
		<td><span class="label label-success">Available</span></td>
		<td>Dermatology,Venerology & Leprosy.</td>
		<td><button class="btn btn-block btn-danger btn-xs">Offline</button></td>
		</tr>
		<tr>
		<td>175</td>
